...
g_l["YEAR_FWD"] = "Avancer d'un an";
g_l["YEAR_BCK"] = "Reculer d'un an";
g_l["CLOSE"] = "Fermer";
g_l["ERROR_2"] = g_l["ERROR_1"] = "Date invalide";
g_l["ERROR_4"] = g_l["ERROR_3"] = "Cible invalide";
...
/*
	...
	Thank you!
*/
g_jsDatePickImagePath = "../../assets/img/jsdatepick/";
...
JsDatePick.prototype.setConfiguration = function(aConf){
	...
	this.oConfiguration.cellColorScheme = (aConf["cellColorScheme"] != null) ? aConf["cellColorScheme"] : "beige";
	this.oConfiguration.dateFormat		= (aConf["dateFormat"] != null) ? aConf["dateFormat"] : "%Y-%m-%d";
	this.oConfiguration.imgPath			= (g_jsDatePickImagePath.length != null) ? g_jsDatePickImagePath : "../../assets/img/jsdatepick/";
